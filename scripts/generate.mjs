...
function ortsseite(s, o) {
  ...
  const tiefCtaDefault = (s.slug === 'winterdienst') ? { h2: 'Flächen nennen, Saisonangebot bekommen.', txt: 'Kostenlose Besichtigung in ' + o.name + ' durch den Partner-Fachbetrieb, Saisonpreis vor der Zusage, Einsatznachweis nach jeder Räumung.' } : s.partner_modell ? {} : { h2: 'Foto schicken, Festpreis bekommen.', txt: 'Rückmeldung meist am selben Werktag, kostenlose Besichtigung in ' + o.name + ', schriftlicher Festpreis für Räumung und Abtransport.' };
