...
const HERO_OVERRIDE = { renovierung: 'bg-fassade', heckenentfernung: 'svc-heckenschnitt-hero', 'baumstumpf-entfernen': 'svc-gartenpflege-hero', gartenrodung: 'svc-gartenpflege-hero', baumschnitt: 'svc-gartenpflege-hero', galabau: 'svc-gartenpflege-hero' };
