...
<section class="sec" style="padding:14px 0 0"><div class="wrap"><div class="media-band rv">${pic('ratgeber-pflaster-gruenbelag', { alt: 'Vorher und Nachher — gereinigte Steinfläche als Arbeitsnachweis', sizes: '(max-width:1100px) 92vw, 1040px' })}</div></div></section>
