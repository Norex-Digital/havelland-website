...
function home() {
  ...
  const KERN = istWintersaison
    ? [{ slug: 'winterdienst', label: 'Winterdienst', promise: 'Saisonvertrag vor dem ersten Schnee — geräumt wird von einem Partner-Fachbetrieb.' },
...
function b2bPage() {
  ...
  // Partner-Framing: Winterdienst + Dachrinne = Partner-Fachbetrieb (Vertrag Kunde<->Betrieb, Preis vom Betrieb); Laub/Grün/Treppenhaus = Eigenleistung.
